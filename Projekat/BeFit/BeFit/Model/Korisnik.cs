...
namespace BeFit
{
    public class Korisnik
    {
        ...
        private static void ProvjeriIme(string value)
        {
            if (value.Length == 0)
        ...
        public string Prezime
        {
            ...
            set
            {
                ProvjeriPrezime(value);
                prezime = value;
            }
        }

        private static void ProvjeriPrezime(string value)
        {
            if (value.Length == 0)
        ...
        private static void ProvjeriEmail(string value)
        {
