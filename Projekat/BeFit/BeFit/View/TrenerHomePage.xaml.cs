...
namespace BeFit
{
    ...
    /// </summary>
    public sealed partial class TrenerHomePage : Page
    {
        ...
        private void NavView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            ContentFrame.Navigate(typeof(PregledProfilaTreneraPage));
        }
        ...
        private void NavView_ItemInvoked(NavigationView sender, NavigationViewItemInvokedEventArgs args)
        {
            ...
            {
                ContentFrame.Navigate(typeof(OpcijeProfilaTreneraPage));
                ocistiStack();
            }
            else
            {
